...
// Generated by dojo-bindgen on Mon, 26 Aug 2024 18:56:56 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function actions() {
        ...
        const move = async (props: { account: Account, duel_id: bigint, round_number: number, duelist_name: bigint, moves: RecsType.BigIntArray }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
